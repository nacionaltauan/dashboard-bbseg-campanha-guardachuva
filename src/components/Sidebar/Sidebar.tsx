...
import { Home, Clock, Globe, Eye, BarChart3, Users, LogOut, User, BookOpenText, Share2, Video, TrendingUp, Search, List, CheckCircle } from "lucide-react"
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center">
            ...
            {isExpanded && (
              <span className="ml-3 font-semibold text-gray-800 whitespace-nowrap">Dashboard Guarda-chuva</span>
            )}
          </div>
        </div>
